...
try
{
	...
	con=DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/XE","system","root");
	  ...
	  if(rs.next())
	  {
		  PreparedStatement pstmt1 = con.prepareStatement("update customersignup set pass=? where email=?");
		...
		<a href="customerlogin.html">Login Again</a>
				<% 
		  }
		  else
		  {
	...
	<a href="customerpass.jsp">Try Again</a>
				<%   
		  }
	  }
	  else
