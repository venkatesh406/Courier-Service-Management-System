...
<html>
    ...
    <body bgcolor="white">
        ...
        <a href="viewcustomersusers.jsp">customers</a>&nbsp;&nbsp;&nbsp;
...
con=DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/XE","system","root");
 ...
 PreparedStatement pstmt = con.prepareStatement("select * from customersignup");
 ...
 while(rs.next())
{
	...
	<td>
	<a href="deletecustomers.jsp?id=<%=rs.getString("id")%>">DELETE</a>
	</td>
	</tr>
	<%
}
